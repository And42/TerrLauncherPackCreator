...
namespace TerrLauncherPackCreator.Code.Models
{
    public class PackModel
    {
        ...
        public PackModel(
            [NotNull] (string name, string color, string link, ImageInfo icon, int iconHeight)[] authors,
        ...
        [NotNull]
        public (string name, string color, string link, ImageInfo icon, int iconHeight)[] Authors { get; }
