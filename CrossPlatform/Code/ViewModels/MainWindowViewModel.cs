...
{
    public class MainWindowViewModel<TPage> : ViewModelBase
    {
        ...
        public MainWindowViewModel(
            ...
            Func<PackCreationViewModel, TPage[]> createPages,
        ...
        )
        {
            ...
            PackProcessor = new PackProcessor(
                ...
                ConvertImageToTempWebPFile,
                ConvertImageToTempWebPFile2
            );
            ...
            StepsPages = createPages(PackCreationViewModel);
